...
abstract class AbstractCalendar extends UI\Control
{
    ...
    public function render(): void
    {
        ...
        $wdayMaxLen = (int) ($this->options[static::OPT_WDAY_MAX_LEN] ?? PHP_INT_MAX);
    ...
    protected function prepareDate(): void
    {
        ...
        $this->year = (int) $this->year; // @phpstan-ignore cast.useless
        $this->month = (int) $this->month; // @phpstan-ignore cast.useless
    }
}
